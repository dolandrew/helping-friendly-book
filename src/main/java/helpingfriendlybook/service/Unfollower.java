...
public class Unfollower {
    ...
    public void unfollow() {
        ...
        try {
            ...
            LOG.warn("Ratio: " + (new Double(followers.size()) / new Double(friends.size())));
            ...
            LOG.warn("Ratio: " + ((new Double(followers.size()) - new Double(unfollowed.size())) / new Double(friends.size())));
        } catch (Exception e) {
